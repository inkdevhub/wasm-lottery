...
import QueryMethods from '../query/lottery';
import BuildExtrinsicMethods from '../build-extrinsic/lottery';
import TxSignAndSendMethods from '../tx-sign-and-send/lottery';
import MixedMethods from '../mixed-methods/lottery';
import EventsClass from '../events/lottery';
